...
const ControlOfferings = connect(mapStateToProps, mapDispatchToProps)((props) => {
    
    const emptyFunction = () => {
        console.log('Ran empty function');
    }
    const handleMonthly = () => {
        if (props.currentPlan.slice(3) === '1month') {
           props.modifyPageSettings({
                currentPlan: props.currentPlan.replace('1month', '6month')
           }) 
        } else if (props.pageSettings.currentPlan.slice(3) === '6month') {
            props.modifyPageSettings({
                currentPlan: props.currentPlan.replace('6month', '1month')
            }) 
        }
    }
    const handleChangeActiveCard = (plan) => {
        if (props.pageSettings.currentPlan.slice(0, 2) != plan) {
            props.modifyPageSettings({
                currentPlan: props.currentPlan.replace(props.currentPlan.slice(0, 2), plan)
            })
        }
    }

    const handleChangeActiveCardMobile = (plan) => {
        handleChangeActiveCard(plan)
        
    }

    return (
        <div className={classesMaker('sparklydragon')}>
            <section className={props.variables.headerStyle === "control" ? "topSpace" : '' }>
                {props.variables.headerStyle === "control" && <div className="topSpace"></div> }
                <div className="buttonpill-wrap" id="form-plan-container">
                    <div className="buttonpill-inner">
                        <div className="buttonPill">
                            <button type="button" id="monthPill" className={props.currentPlan.slice(3) === '1month' ? "activePill monthPill icon iconCheck" : "inactivePill monthPill"} onClick={handleMonthly}>Monthly</button> 
                            <input id="monthPillInput" className="radioBtn hide" type="radio" name="planPer" value="monthly" onClick={handleMonthly} /> 
                            <button type="button" id="month6Pill" className={props.currentPlan.slice(3) === '1month' ? "inactivePill monthPill" : "activePill monthPill icon iconCheck"} onClick={handleMonthly}>6 Months</button> 
                            <input id="month6PillInput" className="radioBtn hide" type="radio" name="planPer" value="biannual" onClick={handleMonthly} />
                            <div className={props.currentPlan.slice(3) === '1month' ? 'arrow' : 'hide arrow'} id="save20" onClick={handleMonthly}>
                ...
                <form id="mobileOfferForm" action="/checkout/mli?" className="form freetrial-form hidden-md-up">
                    ...
                    <div className="ancGrid ancGridEqual center-grid hide768 show480 subs-plan-container">
                        <section className="subs-plan-outer-wrap us-dis-plan-outer-wrap" onClick={emptyFunction}>
                            <div className="subs-plan-wrap us-dis-plan-wrap usrecords" onClick={() => {handleChangeActiveCardMobile('us')}}>
                                <div className={props.currentPlan.slice(3) === '6month' ? "saving-plan-sixmonths" : "hide" + " saving-plan-sixmonths"}>Save $50**</div>
                                ...
                                <div className="subs-plan-desc">
                                    ...
                                    <span className="us-monthly-plan-detail textsml" id="mobile-us-monthly-plan-detail">
                                        <strong className="bamboo3">$24.99/month</strong> after free trial
                                    </span> 
                                    <span className="hide us-plan-detail plan-detail textsml" id="mobile-us-plan-detail">
                                ...
                                <input id="us1Month" className="radioBtn hide" type="radio" name="offers" value="O-25401" onClick={emptyFunction} /> 
                                <input id="us6Month" className="radioBtn hide" type="radio" name="offers" value="O-23590" onClick={emptyFunction} />
                            </div>
                        </section>
                        <section className="subs-plan-outer-wrap" onClick={emptyFunction}>
                            <div className="subs-plan-wrap world-ex-plan-wrap usnintrecords" onClick={() => {handleChangeActiveCardMobile('we')}}>
                                <div className={props.currentPlan.slice(3) === '6month' ? "saving-plan-sixmonths" : "hide" + " saving-plan-sixmonths"}>Save $90***</div>
                                ...
                                <div className="subs-plan-desc">
                                    ...
                                    <span className="usnint-monthly-plan-detail textsml" id="mobile-usnint-monthly-plan-detail">
                                        <strong className="Wave3">$39.99/month</strong> after free trial
                                    </span> 
                                    <span className="hide usnint-plan-detail plan-detail textsml" id="mobile-usnint-plan-detail">
                                ...
                                <input id="worldex1Month" className="radioBtn hide" type="radio" name="offers" value="O-25405" onClick={emptyFunction} /> 
                                <input id="worldex6Month" className="radioBtn hide" type="radio" name="offers" value="O-22056" onClick={emptyFunction} />
                            </div>
                        </section>
                        <section className="subs-plan-outer-wrap" onClick={emptyFunction}>
                            <div className="subs-plan-wrap allacc-plan-wrap allacc-plan-br-mbl" onClick={() => {handleChangeActiveCardMobile('aa')}}>
                                <div className={props.currentPlan.slice(3) === '6month' ? "saving-plan-sixmonths" : "hide" + " saving-plan-sixmonths"}>Save $100 §</div>
                                ...
                                <div className="subs-plan-desc allacc-plan-desc">
                                    ...
                                    <span className="us-monthly-plan-detail textsml" id="mobile-allaccess-monthly-plan-detail">
                                        <strong className="allaccess-color">$44.99/month</strong> after free trial
                                    </span> 
                                    <span className="hide allaccess-plan-detail plan-detail textsml" id="mobile-allaccess-plan-detail">
                                ...
                                <input id="allacc1Month" className="radioBtn hide" type="radio" name="offers" value="O-25410" onClick={emptyFunction} /> 
                                <input id="allacc6Month" className="radioBtn hide" type="radio" name="offers" value="O-24567" onClick={emptyFunction} />
                            </div>
                        </section>
                    </div>
                </form>
                <form action="/checkout/mli?" className="form freetrial-form" id="signupForm">
                    ...
                    <div className="ancGrid ancGridEqual center-grid hide480 plan-select-tiles">
                        <section className={props.currentPlan.slice(0,2) === 'us' ? "ancCol w33 con usrecords grey-border p10 rounded-2 usdis-ps-wrap usrecords-border" : "ancCol w33 con usrecords grey-border p10 rounded-2 usdis-ps-wrap"} id="usdis-sec" onClick={() => {handleChangeActiveCard('us')}}>
                            <header className="conHeader plan-select-header">
                                <label className="container us-subs-label">
                                    ...
                                    <input data-name="offers" className="month-subs-input" readOnly checked={props.currentPlan.slice(0,2) === 'us'} type="radio" name="offers" value="O-25401" id="usDiscMonthly" aria-labelledby="usDiscovery monthly" /> 
                            ...
                            <div className="conBody">
                                <span className="usrecordsFreeText text4xlrg"><strong>
                                    {props.pageSettings.elligibility === 'freetrial' ? '14 days free' : props.currentPlan.slice(3) === '1month' ? '24.99/month' : '$99.99'}
                                </strong></span> 
                                
                                {props.currentPlan.slice(3) === '1month' && props.pageSettings.elligibility === 'freetrial' &&
                                    <span className="us-monthly-plan-detail" id="us-monthly-plan-detail">
                                        <br />then <strong>$24.99/month.</strong>
                                    </span>
                                }
                                {props.currentPlan.slice(3) === '6month' && props.pageSettings.elligibility === 'freetrial' ?
                                    <span className="us-plan-detail plan-price" id="us-plan-detail">
                                        <br />then <strong>$99.99</strong> every <strong className="border-highlight">6 months</strong>
                                    </span>
                                    : props.currentPlan.slice(3) === '6month' && props.pageSettings.elligibility === 'hardoffer' &&
                                    <span className="us-plan-detail plan-price" id="us-plan-detail">
                                        <br />every <strong className="border-highlight">6 months</strong>
                                    </span>
                                }
                                {props.currentPlan.slice(3) === '6month' &&
                                    <div className={props.currentPlan.slice(3) === '6month' ? "saving-plan-sixmonths" : "hide saving-plan-sixmonths"}>
                                    Saves $50**
                                ...
                                <hr className={props.currentPlan.slice(3) === '1month' ?  "hr-line-mtb10 border-bt-cl plan-month-line" : "hide"} />
                            ...
                            {props.currentPlan.slice(0,2) === 'us' && <button className="ancBtn free-trial-button full-width usdis-bgcolor mb-0 free-trial-btn-md-up" id="usdis-btn" type="submit">Start free trial</button>}
                        </section>
                        <section className={props.currentPlan.slice(0,2) === 'we' ? "ancCol w33 con grey-border p10 rounded-2 worldex-ps-wrap worldex-border" : "ancCol w33 con grey-border p10 rounded-2 worldex-ps-wrap" } id="worldex-sec" onClick={() => {handleChangeActiveCard('we')}}>
                            <header className="conHeader plan-select-header">
                                <label className="container worldex-subs-label">
                                    ...
                                    <input data-name="offers" className="month-subs-input" readOnly checked={props.currentPlan.slice(0,2) === 'we'} type="radio" name="offers" value="O-25405" id="worldExMonthly" aria-labelledby="worldExplorer monthly"/> 
                                    <span className="checkmark"></span>
                                </label>
                            ...
                            <div className="conBody">
                                <span className="usnintrecordsFreeText text4xlrg"><strong>
                                    {props.pageSettings.elligibility === 'freetrial' ? '14 days free' : props.currentPlan.slice(3) === '1month' ? '39.99/month' : '$149.99'}
                                </strong></span>
                                ...
                                {props.currentPlan.slice(3) === '6month' && props.pageSettings.elligibility === 'freetrial' ?
                                    <span className="usnint-plan-detail plan-price" id="usnint-plan-detail">
                                        <br/>then <strong>$149.00</strong> every <strong className="border-highlight">6 months</strong>
                                    </span>
                                    : props.currentPlan.slice(3) === '6month' && props.pageSettings.elligibility === 'hardoffer' &&
                                    <span className="usnint-plan-detail plan-price" id="usnint-plan-detail">
                                        <br />every <strong className="border-highlight">6 months</strong>
                                ...
                                <hr className={props.currentPlan.slice(3) === '1month' ?  "hr-line-mtb10 border-bt-cl plan-month-line" : "hide"} />
                                <p className="plan-description">
                                    Access <span className="bold">billions of international and U.S. records</span> on Ancestry® to find your ancestors’ stories.<span className="text-left textsml see-example-text"><a href="#examples-head-md-up" onClick={emptyFunction}>See example</a></span>
                                </p>
                                <br />
                            </div>
                            {props.currentPlan.slice(0,2) === 'we' && <button className="ancBtn free-trial-button blue worldex-bgcolor full-width mb-0 free-trial-btn-md-up" id="worldex-btn" type="submit">Start free trial</button>}
                        </section>
                        <section className={props.currentPlan.slice(0,2) === 'aa' ? "ancCol w33 con grey-border p10 allacc-sec rounded-2 allacc-ps-wrap allacc-border" : "ancCol w33 con grey-border p10 allacc-sec rounded-2 allacc-ps-wrap"} id="allacc-sec" onClick={() => {handleChangeActiveCard('aa')}}>
                            <header className="conHeader plan-select-header">
                                <label className="container allacc-subs-label">
                                    <span className="textxlrg radio-text text-left">All Access</span> 
                                    <input data-name="offers" className="month-subs-input" readOnly checked={props.currentPlan.slice(0,2) === 'aa'} type="radio" name="offers" value="O-25410" id="worldPlusMonthly" aria-labelledby="allAccess monthly"/> 
                                    <span className="checkmark"></span>
                                </label>
                            ...
                            <div className="conBody">
                                <span className="allaccess-color text4xlrg"><strong>
                                    {props.pageSettings.elligibility === 'freetrial' ? '14 days free' : props.currentPlan.slice(3) === '1month' ? '49.99/month' : '$199.99'}
                                </strong></span> 

                                {props.pageSettings.elligibility === 'freetrial' && props.currentPlan.slice(3) === '1month' &&
                                    <span className="allaccess-monthly-plan-detail" id="allaccess-monthly-plan-detail">
                                        <br />then <strong>$49.99/month.</strong>
                                    </span>
                                }
                                {props.currentPlan.slice(3) === '6month' && props.pageSettings.elligibility === 'freetrial' ?
                                    <span className="allaccess-plan-detail plan-price" id="allaccess-plan-detail">
                                        <br/>then <span className="bold">$199.99&nbsp;</span>every&nbsp;<span className="bold border-highlight">6 months</span>
                                    </span> : props.currentPlan.slice(3) === '6month' && props.pageSettings.elligibility === 'hardoffer' &&
                                    <span className="allaccess-plan-detail plan-price" id="allaccess-plan-detail">
                                        <br/>every&nbsp;<span className="bold border-highlight">6 months</span>
                                    </span>
                            }
                                {props.currentPlan.slice(3) === '6month' &&
                                    <div className={props.currentPlan.slice(3) === '6month' ? "saving-plan-sixmonths" : "hide" + " saving-plan-sixmonths"}>
                                        ...
                                        <div className="fold-img-wrapper">
                                            ...
                                            <span className="tooltiptext tooltip-bottom normal">
                                                ...
                                                <div className="fold-callout-img-wrap textCenter rel-pos">
                                                    ...
                                                    <a href="#examples-head-md-up" onClick={emptyFunction}>
                            ...
                            {props.currentPlan.slice(0,2) === 'aa' && <button className="ancBtn free-trial-button full-width allaccess-btn-bgcolor mt-2 mb-0" id="allacc-btn" type="submit">Start free trial</button>}
                        </section>
                    </div>
                </form>
            </section>
...
const SparklyDragonOfferStyles = connect(mapStateToProps)((props) => {

    return <ControlOfferings/>
});

export default SparklyDragonOfferStyles;